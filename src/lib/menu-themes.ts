export type MenuThemeId =
  "gold" | "emerald" | "royal" | "rose" | "ocean" | "charcoal";
...
> = {
  gold: {
    ...
    primary: "#D4A853",
    label: "ذهبي",
    preview: ["#7c5c10", "#D4A853", "#f0d9a0"],
  },
  emerald: {
    id: "emerald",
    primary: "#3D7A4A",
    label: "زمردي",
    preview: ["#1d4a2a", "#3D7A4A", "#9fd4ac"],
  },
  royal: {
    id: "royal",
    primary: "#5A7FB5",
    label: "ملكي",
    preview: ["#2b3f66", "#5A7FB5", "#b6cbe8"],
  },
  rose: {
    id: "rose",
    primary: "#B85A7A",
    label: "وردي",
    preview: ["#6e2a44", "#B85A7A", "#e8b6c8"],
  },
  ocean: {
    id: "ocean",
    primary: "#2E8B8B",
    label: "أوقيانوسي",
    preview: ["#164d4d", "#2E8B8B", "#9fd4d4"],
  },
  charcoal: {
    id: "charcoal",
    primary: "#4B4B4B",
    label: "فحمي",
    preview: ["#1c1c1c", "#4B4B4B", "#9a9a9a"],
  },
};
...
> = {
  grid: {
    id: "grid",
    label: "شبكة",
    description: "أصناف في شبكة متوازنة",
    previewClass: "grid-cols-2 grid-rows-2",
  },
  list: {
    id: "list",
    label: "قائمة",
    description: "عرض عمودي مريح",
    previewClass: "grid-cols-1 grid-rows-2",
  },
  split: {
    id: "split",
    label: "مقسوم",
    description: "أعمدة متجاورة",
    previewClass: "grid-cols-2 grid-rows-1",
  },
  card: {
    id: "card",
    label: "بطاقات",
    description: "بطاقات بارزة كبيرة",
    previewClass: "grid-cols-1 grid-rows-1",
  },
};
...
export function parseMenuAppearance(raw: string): {
  theme: MenuThemeId;
  color: string;
  layout: MenuLayoutId;
  headerColor?: string;
  ...
  try {
    ...
    const theme =
      parsed.theme && parsed.theme in MENU_THEMES
        ? parsed.theme
        : DEFAULT_MENU_THEME;
    const layout =
      parsed.layout && parsed.layout in MENU_LAYOUTS
        ? parsed.layout
        : DEFAULT_MENU_LAYOUT;
    return {
      theme,
